...
{/* Add-new collection price  */}
                    <p className="mt-1 text-lg text-primary">LKR. {formatPrice(product.price)}</p>
                  </header>
