...
export default function Header() {
  ...
  const { cartProducts } = useContext(CartContext); {/* cart numbers add wenna */}
        ...
        <div className="flex flex-1 items-center justify-end md:justify-between">
          <nav aria-label="Global" className="hidden md:block">
            <ul className="flex items-center gap-6 text-md">
              ...
              <li>
                <Link className={`text-accent transition hover:text-accent/75 ${pathname === ('/products') ? 'text-primary' : ""} `} 
                href="/products">
                  All Products
                </Link>
              </li>
              ...
              <li>
                <select className={`text-accent transition hover:text-accent/75 ${pathname === ('/categories') ? 'text-primary' : ""} `} 
                href="/categories">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="ml-4 flow-root lg:ml-4">
              <Link 
              href="/cart" className="group -m-2 flex items-center p-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
